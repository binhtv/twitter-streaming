...
spark-submit --class "c523.spark_streaming_eg.SparkStreaming" --master local ~/workspace/FinalProject/spark_streaming_eg/target/spark_streaming_eg-0.0.1-SNAPSHOT.jar localhost:9092
